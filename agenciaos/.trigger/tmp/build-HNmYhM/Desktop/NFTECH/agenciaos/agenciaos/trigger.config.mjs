...
async function generateJWT(options) {
  const { SignJWT } = await import("../../../../esm-5T5V4LC2.mjs");
...
async function loadSuperJSON() {
  const superjson = await import("../../../../dist-NUKDDI76.mjs");
...
var RunMetadataAPI = class _RunMetadataAPI {
  ...
  #getManager() {
    return getGlobal(API_NAME11) ?? NOOP_MANAGER;
  }
  enterWithMetadata(metadata2) {
...
var WaitUntilAPI = class _WaitUntilAPI {
  ...
  #getManager() {
    return getGlobal(API_NAME12) ?? NOOP_MANAGER2;
  }
  register(promise) {
...
var RunTimelineMetricsAPI = class _RunTimelineMetricsAPI {
  ...
  #getManager() {
    return getGlobal(API_NAME14) ?? NOOP_MANAGER3;
  }
};
...
var TaskCatalogAPI = class _TaskCatalogAPI {
  ...
  setGlobalTaskCatalog(taskCatalog2) {
    return registerGlobal(API_NAME15, taskCatalog2);
  }
  disable() {
  ...
  #getCatalog() {
    return getGlobal(API_NAME15) ?? NOOP_TASK_CATALOG;
  }
};
